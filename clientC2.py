...
def position(board):
    ...
    if count<5:
        ...
        y=pos[count][1]
        print ships[count]
        board.fill(pygame.Color("grey"),(430,40,360,40))
        font = pygame.font.Font(None, 27)
        text = font.render('POSITION YOUR SHIPS : '+ships[count], 1, (10, 10, 10))
        board.blit(text, (450,50))
...
def enemy(d,x,y,board1,ttt):
    print 'in enemy'
    board1.fill(pygame.Color("grey"),(430,40,360,40))
    font = pygame.font.Font(None, 27)
    text = font.render('OPPONENT TURN', 1, (10, 10, 10))
    board1.blit(text, (450,50))
...
while not crashed:
    ...
    while True:
        ...
        if f==0:
            ...
            board1.fill(pygame.Color("grey"),(430,40,200,40))
            font = pygame.font.Font(None, 27)
            text = font.render('YOUR TURN', 1, (10, 10, 10))
            board1.blit(text, (450,50))
